...
/**
 * Training Data Restoration Script
 * This script restores Atlas Fitness training data from the comprehensive SOP
 */

const trainingData = {
  // Atlas Fitness Business Information
  business_info: {
...
// Export for use in restoration
if (typeof module !== 'undefined' && module.exports) {
  module.exports = trainingData;
}

console.log('Atlas Fitness Training Data Schema:');
console.log('=====================================');
Object.keys(trainingData).forEach(key => {
  console.log(`${key}: ${trainingData[key].content.length} characters`);
});
console.log('=====================================');
console.log('Ready for database restoration');